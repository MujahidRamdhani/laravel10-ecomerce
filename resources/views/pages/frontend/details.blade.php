        ...
        <div class="slider">
          ...
          <div class="preview">
            <div class="item rounded-lg h-full overflow-hidden">
              <img
                src="{{ url($product->galleries()->exists() ? Storage::url($product->galleries->first()->url): 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==') }}"
                alt="front"
                class="object-cover w-full h-full rounded-lg"
              />
            </div>
